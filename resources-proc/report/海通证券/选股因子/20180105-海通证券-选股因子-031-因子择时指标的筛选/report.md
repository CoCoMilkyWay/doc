...
$$
\operatorname*{min}_{\beta_{0},\beta}(\frac{1}{2N}{\sum_{i=1}^{N}}{\left(y_{i}-\beta_{0}-x_{i}^{T}\beta\right)^{2}}+\lambda\sum_{j=1}^{p}{\left|\beta_{j}\right|})
$$
...
$$
\operatorname*{min}_{\beta_{0},\beta}(\frac{1}{2N}\sum_{i=1}^{N}\bigl(y_{i}-\beta_{0}-x_{i}^{T}\beta\bigr)^{2}+\lambda(\alpha\sum_{j=1}^{p}\bigl|\beta_{j}\bigr|+(\frac{1-\alpha}{2})\sum_{j=1}^{p}\beta_{j}^{2}))
$$
...
$$
log\frac{P_{t}}{1-P_{t}}=\alpha+C_{1,t}X_{1,t}+C_{2,t}X_{2,t}+\cdots+C_{N,t}X_{N,t}+\varepsilon_{\mathrm{t}}
$$
