...
在下文分析中，我们以 TOT 代表前 3个月所有分析师对某公司撰写的报告总篇数，即分析师覆盖度。例如 $\mathsf{TOT}_{\mathsf{i},\mathsf{m}}$ 即为，站在第 m 个月末，股票 i前 3 个月的报告总篇数。
...
其中， $\mathsf{Size}_{\mathsf{i},\mathsf{m}}$ 为股票 i在 m 月末的对数总市值， $\sf{Turn}_{i,m}$ 为前 3个月的日均换手率， $\mathsf{Pret}_{\mathsf{i},\mathsf{m}}$ 为前 3 个月的累计收益率。按照上述方程处理后，回归残差项 $\pmb{\varepsilon}_{\mathrm{i,m}}$ 即为特质覆盖度，我们在后文中以 ATOT 表示。ATOT 越大，表明相比于同等市值、流动性、前期收益的股票，该公司获得的分析师关注度更高。
