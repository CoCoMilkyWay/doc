...
$$
\gamma_{j}=-cov\left(\Delta p_{j},\Delta p_{j+1}\right)\tag{6}
$$
...
1、基于t时刻的最高价 $P_{t}^{H}$ 和最低价 $P_{t}^{H}$ ，计算t时刻中间价 $\begin{array}{r}{{\bf\nabla}\cdot{P}_{t}^{mid}=\frac{{P}_{t}^{H}-{P}_{t}^{H}}{2};}\end{array}$
