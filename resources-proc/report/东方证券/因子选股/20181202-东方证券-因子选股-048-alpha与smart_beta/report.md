...
$$
\begin{aligned}&I^{*}=a_{1}\times(\frac{S}{ADV})^{a_{2}}\times\sigma^{a_{3}}\\&MI=b_{1}\times I^{*}\times POV+(1-b_{1})\times I^{*}\\\end{aligned}
$$
...
$$
w_{i}=\left\{\begin{aligned}&(1+z_{i})\cdot w_{i}^{0}\quad if\ z_{i}\geq0\\&(1-z_{i})^{-1}\cdot w_{i}^{0}\quad if\ z_{i}<0\end{aligned}\right.
$$
