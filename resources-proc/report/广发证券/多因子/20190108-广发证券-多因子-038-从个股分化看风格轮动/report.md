...
在备选的K个因子中，计算t时刻过去N期（下文取N=6）的 $IC_{-}IR_{\mathrm{t,i}},$ ，将因子历史IC_IR绝对值为5档，根据 $IC\_IR_{\mathrm{t,i}}$ 绝对值所处的档位从低到高分别给因子打分。
...
$$
w_{i}=\frac{Score_{i}}{\left/\sum_{j=1}^{N}Score_{j}\right.}
$$
