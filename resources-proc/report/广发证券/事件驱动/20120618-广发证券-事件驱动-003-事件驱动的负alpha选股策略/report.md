...
最后，我们看一下各个策略的实际投资效果。我们假设股票双向交易成本为0.5%，不考虑杠杆，最终实现收益率的计算公式为- $\scriptstyle\mathrm{r}(\mathrm{r}_{\mathrm{s}}-\mathrm{r}_{\mathrm{i}}+\mathrm{c}+0.5)/2$ 。我们对未来能看到的所有机会平均投资，时间范围从2011 年至今。
