...
在2005年5月1 日至2011 年 3月 25日间，不考虑交易成本，组合 PB(h,1)的收益率为 555.38%，年化收益率为 37.50%，好于同期沪深 300指数的表现。在18期中，组合 $\mathbf{PB}(\mathbf{h},\mathbf{1})$ 有11期跑赢了沪深 300指数，跑赢概率为 61.11%。若考虑交易成本，组合PB(h,1)的区间累计收益率为 421.52%，年化收益率为 32.28%，高于同期沪深300指数的收益。
