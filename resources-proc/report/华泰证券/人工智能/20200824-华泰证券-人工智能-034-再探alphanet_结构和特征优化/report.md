...
4. 多空组合收益计算方法：用 Top 组每天的收益减去 Bottom 组每天的收益，得到每日多空收益序列 $\boldsymbol{\mathrm{r}}_{1},\boldsymbol{\mathrm{r}}_{2},\cdots,\boldsymbol{\mathrm{r}}_{\mathrm{n}}$ ，则多空组合在第n天的净值等于 $(1+\mathrm{r}_{1})(1+\mathrm{r}_{2})\cdots(1+\mathrm{r}_{\mathrm{n}})$
...
4. 多空组合收益计算方法：用 Top组每天的收益减去 Bottom 组每天的收益，得到每日多空收益序列 $\boldsymbol{\mathrm{r}}_{1},\boldsymbol{\mathrm{r}}_{2},\cdots,\boldsymbol{\mathrm{r}}_{\mathrm{n}}$ ，则多空组合在第n天的净值等于 $(1+\mathrm{r}_{1})(1+\mathrm{r}_{2})\cdots(1+\mathrm{r}_{\mathrm{n}})$
