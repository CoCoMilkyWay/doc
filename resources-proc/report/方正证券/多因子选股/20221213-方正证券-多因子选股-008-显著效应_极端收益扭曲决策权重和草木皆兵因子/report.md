...
从测试结果来看，上述三个因子 Rank IC 分别为-7.49%、-8.66%和-9.32%，Rank ICIR 为-3.31、-2.98 和-3.87，多空组合年化收益率为23.45%、23.09%和 26.49%，选股效果较为优秀。并且相较于传统反转因子和波动因子，IC及 IR 指标均有大幅提高，改进效果较为明显。
