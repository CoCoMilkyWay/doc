...
参考前人的研究，本文选用了 94 个因子 $c_{i,t}$ 用于刻画公司特征，80 个 0-1 变量 $\cdot d_{i,t}$ 用于划分公司行业（划分标准参照《上市公司行业分类指引》（CSRC, 2012）），以及 11 个因子 $\chi_{t}$ 用于刻画宏观特征。总的来说，可以将因子集 $z_{i,t}.$ 表示为下式，其中，⊗表示 Kronecker 内积。

$$
{\boldsymbol{z}}_{i,t}=\left({\begin{array}{c}{c_{i,t}}\\{\chi_{t}\otimes c_{i,t}}\\{d_{i,t}}\end{array}}\right)\tag{1}
$$
...
表 2: 年度样本外预测的 $\scriptstyle{\mathbf{{R}}}^{2}$ （%）
