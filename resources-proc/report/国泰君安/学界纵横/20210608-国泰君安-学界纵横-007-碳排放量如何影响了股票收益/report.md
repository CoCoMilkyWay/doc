...
$$
a_{1,t}=c_{0}+c\pmb{F}_{t}+\varepsilon_{t}
$$

其中 $a_{1,t}$ 是上一节通过横截面方法得到的碳排放风险因子， $F_{t}$ 为一系列风险因子，包括MKTRF、HML、SMB、MOM、CMA等经典因子，来自于Ken French；BAB是长期投资于低 β股票而短期投资于高β 股票的投资组合的月收益；LIQ 是Pastor和Stambaugh构建的流动性因子。
