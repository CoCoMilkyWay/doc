...
$$
\overline{vol_{1}}=(\sum_{T=1}^{5}vol_{T})/5,\quad T_{1}即务预装交布后前个交易口
$$
...
$\overline{{vol_{2}}}\textless\overline{{vol_{1}}}$ 的样本数量占比达到 79%，由此可见预案后一周内的成交量
