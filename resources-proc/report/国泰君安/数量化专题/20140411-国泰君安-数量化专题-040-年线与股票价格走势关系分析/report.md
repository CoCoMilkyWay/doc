...
趋势力度： $\rho~=~\frac{\mathbf{P}_{2}-\mathbf{P}_{1}}{\mathbf{P}_{1}\mathbf{N}}$ ，其中 N为从 P1到 P2持续的时间。
...
即使二者的趋势力度 $\rho~=~\frac{\mathbf{P}_{2}\cdot\mathbf{P}_{1}}{\mathbf{P}_{1}\mathbf{N}}$ 取值一样，也可以认为站在当下，第一
