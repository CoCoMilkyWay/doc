...
若 30 分钟级别第 4段下跌已确认，且第 3 段上涨终点 c低于第 1段上涨终点 a，即 ${\cal P}_{c}{<}{\cal P}_{a}$ ，则称日线级别的上涨中出现了阻击。
...
了第 4 段上涨终点 a，即 $P_{c}\ge P_{a}$ ，则称日线级别的下跌中出现了向上突破。
...
- 止损操作收益率（以下简称止损收益率） $\mathrm{~\bf~\ /~}=\mathrm{~(~}P_{S3}-P_{B}\mathrm{~)~}/P_{B}\times100\%$
