...
何康 徐特等 华泰证券金融工程 2026-03-22 22:34 上海

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=Mzg5OTg3NzY5Mw==&mid=2247513368&idx=1&sn=79902cbfe76afb02ab0b3ced0285137f&chksm=c1a9d2f3d4a91cc2097fc056be22d9989d1752f84dd8eb56f094de9131bf62f97117fbebc613#rd](https://mp.weixin.qq.com/s?__biz=Mzg5OTg3NzY5Mw==&mid=2247513368&idx=1&sn=79902cbfe76afb02ab0b3ced0285137f&chksm=c1a9d2f3d4a91cc2097fc056be22d9989d1752f84dd8eb56f094de9131bf62f97117fbebc613#rd)

![](assets/001.png)

全球流动性环境出现较大扰动，高流动性资产尤其是前期浮盈较多的资产被无差别卖出，导致股债金之间的相关性显著提升，主流量化模型因进入尾部风险区域，参考价值变得有限。在这种场景下，降低组合波动率或是较优应对方式。
...
本周观点：**股债金对冲效果降低，降波或是较优应对方式**

上周伊朗局势仍然不明朗，全球流动性环境出现较大扰动，高流动性资产尤其是前期浮盈较多的资产被无差别卖出，导致股债金之间的相关性显著提升：在2025-12-31，A股和美股、国债、黄金的20日相关性分别为微弱负相关、显著负相关、微弱正相关；而到上周五，A股和美股、国债、黄金的20日相关性分别为微弱正相关、微弱正相关、显著正相关。这意味着靠配置美股、国债、黄金来对冲A股的波动效果打折扣。也正因如此，全天候策略上周也出现了较大回撤。同时，主流量化模型因进入尾部风险区域，参考价值变得有限。在这种场景下，降低组合波动率或是较优应对方式。

A股技术打分模型：维持谨慎观点

A股技术打分模型旨在充分挖掘技术面信息刻画市场状态，基于对当前市场状态的理解，从价格、量能、波动、趋势、拥挤等多维度形成对未来的打分观点。今年以来，模型对万得全A多空择时收益2.67%，同期万得全A收益0.96%，超额收益1.71%；上周A股技术打分模型收益2.51%，超额收益6.64%。模型最新信号显示，所有宽基得分均处于谨慎区间，建议谨慎参与。
...
行业轮动模型：看好商贸零售、消费者服务、保险、通信、工业金属

行业轮动模型采用遗传规划技术直接对行业指数的量价、估值等特征进行因子挖掘，每季度末更新因子库。模型周频调仓，每周末选出多因子综合得分最高的五个行业进行等权配置。今年以来，模型取得绝对收益2.89%，跑赢行业等权基准0.58 pct。上周市场波动继续放大、没有明确主线，模型持仓中保险加必需消费的组合起到了避险作用，同时通信在周五迎来大涨，帮助模型大幅跑赢基准2.56 pct。本周模型继续看好商贸零售、消费者服务、保险、通信，剔除饮料，纳入工业金属，组合的成长性有所提升。

  

中国境内全天候增强组合：今年以来绝对收益5.00%

中国境内全天候增强组合采用宏观因子风险预算框架，选取增长超预期/不及预期、通胀超预期/不及预期四种宏观风险源作为平价对象；在四象限风险平价的基础上，基于宏观预期动量的观点主动超配看好象限，实现全天候增强。根据前期报告《全球三层次流动性风险预警模型》（2026-03-15）的模型观点，全球流动性处于高压状态已逾50个交易日，历史上类似时期全球风险资产集体承压的概率在90%以上，降波或是较优应对方式。上周全天候策略迎来“逆风期”，收跌2.49%，今年以来策略的绝对收益为5.00%。
...
基于技术打分构建多空择时策略，规则如下：当得分大于+0.33，看多；得分处于\-0.33至+0.33之间，看平；得分小于\-0.33，看空。今年以来，A股技术打分模型对万得全A多空择时收益2.67%，同期万得全A收益0.96%，超额收益1.71%。上周A股技术打分模型收益2.51%，同期万得全A收益-4.13%，超额收益6.64%。
...
今年以来策略收益为7.71%，同期基准为3.11%，模型超额收益为4.60%。模型本周维持看多红利：其中，相对动量和银行间市场成交量维持看多，期限利差看好成长。
...
今年以来策略收益6.32%，同期基准为2.56%，模型超额收益为3.76%。**目前，模型运行在低拥挤区间，采用大参数双均线模型判断趋势，看好小盘。**

![](assets/008.png)

03 行业轮动模型：看好社服、保险、商贸零售、通信、饮料  

遗传规划行业轮动模型的底层资产为32个中信行业指数，因子更新频率为季频，调仓频率为周频。每周末，模型选出多因子综合得分最高的五个行业进行等权配置，次周第一个交易日按均价完成调仓。回测始于2022-09-30，其中模拟盘跟踪始于前期报告《双目标遗传规划应用于行业轮动》（2024-05-20）的发布。今年以来，模型取得绝对收益2.89%，跑赢行业等权基准0.58 pct。上周市场波动继续放大、没有明确主线，模型持仓中保险加必需消费的组合起到了避险作用，同时通信在周五迎来大涨，帮助模型大幅跑赢基准2.56 pct。本周模型继续看好商贸零售、消费者服务、保险、通信，剔除饮料，纳入工业金属，组合的成长性有所提升。
...
今年3**月模型****增配“增长不及预期”和“通胀超预期”象限****，****增配商品和黄金；股票内部减配非防御性股票，增配红利类；债券维持平配****。根据前期报告《全球三层次流动性风险预警模型》（2026-03-15）的模型观点，全球流动性处于高压状态已逾50个交易日，历史上类似时期全球风险资产集体承压的概率在90%以上，降波或是较优应对方式。上周，没有考虑流动性风险预警模块的全天候策略迎来“逆风期”，收跌2.49%，今年以来策略的绝对收益为5.00%。**
