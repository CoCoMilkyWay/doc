...
何康 徐特等 华泰证券金融工程 2026-08-16 22:40 上海

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=Mzg5OTg3NzY5Mw==&mid=2247515156&idx=1&sn=0c17f1399a58e7d70deb69fb091b3652&chksm=c131bf4bcb8a54c1f960a0202514b6944a0974e53b9da7bbe835fc34be83376d2e1492b13f09#rd](https://mp.weixin.qq.com/s?__biz=Mzg5OTg3NzY5Mw==&mid=2247515156&idx=1&sn=0c17f1399a58e7d70deb69fb091b3652&chksm=c131bf4bcb8a54c1f960a0202514b6944a0974e53b9da7bbe835fc34be83376d2e1492b13f09#rd)
...
上周全球资本市场呈现震荡格局，上证指数小幅下跌0.33%、纳斯达克指数小幅上涨0.14%，且均有所缩量；其中上证指数三次冲击年线均未果。在美债利率高位反复、全球流动性尚不明朗的环境下，指数继续维持震荡的概率较高。风格择时模型因部分信号维度偏右侧，受前期成长风格高波动干扰较大，信号变化仍然较为频繁，近期表现一般，在震荡市背景下建议按均衡配置处理。行业轮动模型年内超额收益已修复转正，信号新纳入电子。上周美股DRAM上涨13.28%，而A股电子行业仅上涨0.42%，考虑到电子行业大幅缩量、拥挤度得分已归零，在美股DRAM强势的背景下或有继续反弹的空间；而近期表现强势的医药触发了4分高拥挤，建议适度止盈。
...
行业轮动模型：建议关注通信、有色、电子、汽车及其零部件

行业轮动模型采用遗传规划技术直接对行业指数的量价、估值等特征进行因子挖掘，每季度末更新因子库。模型周频调仓，每周末选出多因子综合得分最高的五个行业进行等权配置。今年以来，模型取得绝对收益\-1.95%，跑赢行业等权基准0.47 pct。上周市场呈现震荡格局、行业轮动速度较快，但得益于北美算力链的高景气，通信设备走势较强，位列全行业首位。模型因成功选中通信设备，超额收益继续修复，年内超额收益已转正。本周，模型继续持有通信设备、工业金属、商用车和汽车零部件，剔除轻工制造、纳入电子，成长风格占比提升。

  

中国境内全天候增强组合：今年以来绝对收益3.12%

中国境内全天候增强组合采用宏观因子风险预算框架，选取增长超预期/不及预期、通胀超预期/不及预期四种宏观风险源作为平价对象；在四象限风险平价的基础上，基于宏观预期动量的观点主动超配看好象限，实现全天候增强。8月配置观点为增配“增长不及预期”和“通胀不及预期”两个象限：股票端维持防御；债券端整体超配；商品端除黄金外，其他品种继续低配。上周，全天候策略收涨0.29%。今年以来策略的绝对收益为3.12%。
...
基于多维打分构建多空择时策略，规则如下：当得分大于0，看多；得分等于0，看平；得分小于0，看空。今年以来，多维打分模型\_A对万得全A多空择时收益5.20%，上周收益-1.10%；多维打分模型\_B对万得全A多空择时收益-10.17%，上周收益-1.91%。当前全部宽基指数的得分均位于谨慎区间。
...
今年以来策略收益为3.99%，同期基准为2.77%，模型超额收益为1.22%。模型本周观点从均衡配置切换为看多红利。其中，相对动量由看多红利切换为中性，期限利差由中性切换为看多红利，银行间市场成交量由看多成长切换为中性。
...
今年以来策略收益6.32%，同期基准2.66%，模型超额收益3.66%。当前，大盘拥挤度和小盘拥挤度均在正常区间内，两者相对趋势强弱并不明朗。
...
行业轮动模型：关注通信、有色、电子、汽车及其零部件

遗传规划行业轮动模型的底层资产为33个中信行业指数，因子更新频率为季频，调仓频率为周频。每周末，模型选出多因子综合得分最高的五个行业进行等权配置，次周第一个交易日按均价完成调仓。回测始于2022-09-30，模拟盘跟踪始于2024-05-20。今年以来，模型取得绝对收益-1.95%，跑赢行业等权基准0.47 pct。上周市场呈现震荡格局、行业轮动速度较快，但得益于北美算力链的高景气，通信设备走势较强，位列全行业首位。模型因成功选中通信设备，超额收益继续修复，年内超额收益已转正。本周，模型继续持有通信设备、工业金属、商用车和汽车零部件，剔除轻工制造、纳入电子，成长风格占比提升。
...
8月配置观点为增配“增长不及预期”和“通胀不及预期”两个象限：股票端维持防御；债券端整体超配；商品端除黄金外，其他品种继续低配。上周，全天候策略收涨0.29%。今年以来策略的绝对收益为3.12%。
...
研报《金工：行业轮动模型重新关注电子行业》2026年8月16日
