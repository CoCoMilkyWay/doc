# 金融程序员因少发15万年终奖，用逻辑炸弹摧毁2500万服务器，并且...

量化君 量化君也 2026-03-31 21:15 广东

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=MzkyODI5ODcyMA==&mid=2247487271&idx=1&sn=abb1d96f3c843c73bd9f90b4d1b2506b&chksm=c3e173bb3f5723d0cd9375c045f18536fbc199c96f3999b2b8a9708dfb321753af9d368de888#rd](https://mp.weixin.qq.com/s?__biz=MzkyODI5ODcyMA==&mid=2247487271&idx=1&sn=abb1d96f3c843c73bd9f90b4d1b2506b&chksm=c3e173bb3f5723d0cd9375c045f18536fbc199c96f3999b2b8a9708dfb321753af9d368de888#rd)

![](assets/001.png)

  

最近行情飘忽，跟大伙儿讲个故事吧，起因是我查一个IT术语时，发现一桩陈年往事，看完来龙去脉之后，不禁一声叹息，应该不同的人看完，会在不同的角度，有不同的感受见解。

  

在金融交易的丛林里，最危险的敌人往往不在竞争对手的交易室，而在自家的服务器机房。一名资深程序员因年终奖未达预期，亲手写下逻辑炸弹代码，并孤注一掷买入大量看跌期权，试图在任职公司的废墟上种下自己的摇钱树。

  

1 矛盾骤起

本次故事发生在2002年，主角名叫罗杰·杜罗尼奥（Roger Duronio），为了方面描述，就称呼他为老罗吧，老罗当时年近花甲，在同事眼中，老罗是个典型的中老年工科男程序员，沉默寡言，技术精湛，对瑞银集团（UBS）复杂的服务器网络了如指掌。

  

作为资深老员工，他当时的年薪就已经达到了12.5w美元，按当时的汇率换算大约是100w人民币，这在2000年代初绝对算中产阶层了。
...
老罗当时负责维护瑞银在全美交易的数千台服务器，手里握着进入瑞银网络的最高权限，辛辛苦苦工作的2001年过去了，老罗预计自己能拿到5w美元的年终奖，然而，不出意外的话，就一定出意外了，当他满心欢喜打开工资单时，看到的数字是3.25w美元。

  

1.75w美元，约合人民币15w的落差，成了飘进炸药桶的火星。

  

在老罗看来，这不仅是钱的问题，更是公司对他个人价值的低估和羞辱。他没有像普通员工那样去HR办公室抱怨，而是在2002年2月22日果断辞职，并冷冷留下一句“你们等着瞧，我会让瑞银付出代价”。

  

2 逻辑炸弹

辞职前，老罗并没有急着搬走个人物品，他利用自己的系统管理员的最高权限（Superuser Privilege），在瑞银全美370个办公室的1000多台服务器当中，悄悄埋下了一段极其简洁却极其致命的C语言代码——逻辑炸弹（Logic Bomb）。

  

所谓的“逻辑炸弹”，它是一个专门的计算机术语，是指在特定条件（如特定时间、特定账号状态、收到特定消息）下才会触发的恶意程序，它比常见的病毒更容易隐藏行踪。

  

老罗的技术逻辑非常毒辣， 他将逻辑炸弹的引信设定在2002年3月4日上午9:30触发。这正是纽约证券交易所（NYSE）开市的时间，他要让瑞银在最繁忙最关键的时刻，瞬间变成瞎子和聋子。

  

毁灭代码触发后的指令只有一行，类似于Linux系统中的“rm -rf /”，懂计算机的小伙伴都知道这意味着什么，系统将从根目录开始，递归删除所有文件。这些个逻辑炸弹被复制到了瑞银在全美的所有分支机构，甚至连备份服务器都不放过。

  

他目标是不仅要让公司瘫痪，还要让瑞银的数据彻底消失，让这家金融帝国在数据层面上“归零”。

  

3 复仇升级

如果老罗只是想报复，那最多只能算一个疯狂的黑客，但他作为金融公司的老兵，其厉害之处在于，他还要搂草打兔子，要试着利用这次破坏来大赚一笔。

  

在炸弹爆炸前夕，他自掏腰包，买了2万多美元瑞银股票的看跌期权（Put Options），瑞银股价跌得越狠，自己就赚得越多。

  

离职当天，他并没有急着去找新的工作，也没有去酒吧消愁，而是直接跑到自己的证券经纪人那里，动用个人存款甚至套现了退休金账户，豪掷21762美元买了318张瑞银股票的看跌期权。面对经纪人的劝阻时，他还愤怒说道“老天爷知道我为了复仇能做出什么”(God knows what I can do to get even)。

  

他还特意把期权行权日定在3月15日，刚好覆盖逻辑炸弹爆发后的市场波动窗口，真的是算盘打得噼啪响。他的逻辑闭环了：

  

引爆逻辑炸弹 -> 瑞银交易系统全线瘫痪 -> 消息传出，瑞银股价暴跌 -> 看跌期权价值暴涨

  

这样他不仅报了仇，还弥补了年终奖缺口，甚至可能赚到上百万刀乐，这种“一边安置炸弹，一边买入期权”的操作，将技术犯罪提升到了内幕交易型破坏的高度，也有三四层楼那么高了。
...
就在华尔街的交易员们准备开始新一周拼杀的时候，瑞银的电脑屏幕开始接连变黑。从波士顿到旧金山，从休斯敦到西雅图，数千名经纪人发现自己无法登录系统，无法下达指令，甚至连查看客户资料都提示“找不到路径”。
...
由于删除指令是从底层执行的，系统不仅删除了业务代码，就连操作系统本身的内核文件也遭到了破坏，服务器在那一瞬间都成了废铁。

  

瑞银不得不紧急动员全美的技术团队进行修复，为了挽救数据，公司付出了惨痛的代价。服务器损失方面，修复和更换硬件、恢复数据共耗资超300w美元，约2500w人民币。业务损失更是无法估量。在系统瘫痪的数天内，无数大客户因为无法交易而愤怒撤资，瑞银的信誉遭受了重创。

  

5 结局唏嘘

老罗本以为自己策划了一场完美的犯罪，但他犯了两个致命错误。

  

第一，他高估了单次系统瘫痪对瑞银股价的影响。虽然瑞银系统崩溃，但它是一个庞然大物，市场在评估了其整体资产后，股价并没有如他预期的那样闪崩，股价最低时都没有碰到他的行权价，那2万多美元的期权费，最终随着行权日的临近而打了水漂。年终奖差额不仅没有赚回来，就连年终奖也折了一大半。

  

第二，他低估了FBI对异常行为的捕捉能力。在案件调查中，FBI并没有陷入代码的迷宫，而是直接查阅了瑞银股票的期权异常波动。在全美买入瑞银看跌期权的人名单里，调查员一眼就看到了那个刚离职不久、曾扬言要报复公司的资深程序员——老罗。

  

同时，他在辞职时对同事和经纪人说过的那些带有威胁/愤怒色彩的话，也成为了法庭上钉死他的证据。

  

2006年，该案在新泽西州纽瓦克(Newark, New Jersey)联邦法院宣判。

  

尽管老罗在法庭上坚称自己是被诬陷的，是系统本身的Bug或者是外部黑客所为，但是针对他的证据链完美闭环：老罗在公司电脑上测试恶意代码的残留、他购买期权的银行账户、以及他那著名的报复宣言。
...
最终，老罗被判处97个月（8年零1个月）监禁，并被要求赔偿瑞银310w美元，约合2600w人民币。
