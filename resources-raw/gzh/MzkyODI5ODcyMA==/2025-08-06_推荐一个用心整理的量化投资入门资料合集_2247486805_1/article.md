...
量化君 量化君也 2025-08-06 07:07 广东

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=MzkyODI5ODcyMA==&mid=2247486805&idx=1&sn=08e67f801fc1057fae11e79edbf2eaf2&chksm=c3d75b9a8fd520bd6069657c02f713154993db97157c629130b872ca91ed7b632bd755336cc4#rd](https://mp.weixin.qq.com/s?__biz=MzkyODI5ODcyMA==&mid=2247486805&idx=1&sn=08e67f801fc1057fae11e79edbf2eaf2&chksm=c3d75b9a8fd520bd6069657c02f713154993db97157c629130b872ca91ed7b632bd755336cc4#rd)

![](assets/001.png)

  

前几天闲逛时，碰到了一个量化研究入门资料合集，当时随手发到了群里，想不到反馈很不错。后来觉得，他应该能帮助到更多的人，特别是还处在量化入门阶段的萌新，也不藏着掖着了，这个合集的网址我就贴在下面。
...
别看标题和框架是英文，就以为是国外的量化项目，就打怵了，其实这个Github项目是国内高校的金融科技协会发起和维护的，是一群大学生入门量化交易时收集的各种各样的量化干货，主打的就是一个接地气和用心，能非常契合国内萌新宽客的学习需求，更适合中国宝宝体质。
...
我接下按照萌新入门的一般流程，对其中的资料内容进行梳理，方便大伙儿能快速对这个项目的量化资料合集有个大致的了解。

  

首先是推荐了3个经典量化课程的学习资料，先帮助大伙儿了解什么是量化，以及Python基础的入门。
...
第二就是推荐国内外的量化平台，学习量化策略的开发、编写、回测和实盘。
...
第三就是金工研报，研报主题包含但不限于：量化选股、量化择时、期货量化、另类策略、多因子、AI量化......里面的研报数量非常多，下图只是截取一部分研报列表。
...
第四就是量化论文，跟金工研报的目的一样，为初学者提供各种各样的交易研究思路，非常用心地分门别类一一列举出来，以下也是其中一部分截图。
...
第五就是量化专题，在专题底下会提供相关的资料内容，方便进行深入研究，目前专题包括：数据源与另类数据、回测框架、因子挖掘与评估、因子组合、投资组合优化与风控、基金研究与FoF、高频交易。
...
主体内容就是这些，完整的内容请访问上面的Github网址，除了能看到更全更新的内容外，关键还可以给他们一个充满鼓励的Star，用心的好项目值得更多人看见。

  

对了，目前国内访问Github会出现网络不稳定的情况，因为整个合集资料包比较大，下载容易意外中断，没有梯子的小伙伴可以在公众号后台回复暗号『量化入门』，便可以获取到国内的下载和保存方式。当然了，里面的内容只是截止到文章发布的这个时间节点，往后更新的内容是没有的，所以还是建议访问原网址，别忘了顺手给个Star。

  

这里再列举一些往期的量化资源分享，感兴趣的小伙伴也可以看一下。

  

[量化交易打怪升级全攻略](https://mp.weixin.qq.com/s?__biz=MzkyODI5ODcyMA==&mid=2247486384&idx=1&sn=a1d00fcf058755df0f2b51cda5a2ab5a&scene=21#wechat_redirect)

  

[关于量化交易的一切，基本都在这里了](https://mp.weixin.qq.com/s?__biz=MzkyODI5ODcyMA==&mid=2247486076&idx=1&sn=7265e59cd5b9a9716a83b1a4cfb416b4&scene=21#wechat_redirect)

  

[推荐一本量化宝藏书籍，内含151个量化交易策略](https://mp.weixin.qq.com/s?__biz=MzkyODI5ODcyMA==&mid=2247484775&idx=1&sn=90a7e0d3786f9dd2d97a7ba95ec69318&scene=21#wechat_redirect)
