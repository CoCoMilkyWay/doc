...
QuantML QuantML 2024-06-01 20:12 上海

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=Mzg2MzAwNzM0NQ==&mid=2247484528&idx=1&sn=01c2c5c1be9c62ee11936badd36aca81&chksm=cff4c49052d551515d73bc49a2bc9064d486f0e9958e7a82d77ce0f8873a0223b93160f8b2a5#rd](https://mp.weixin.qq.com/s?__biz=Mzg2MzAwNzM0NQ==&mid=2247484528&idx=1&sn=01c2c5c1be9c62ee11936badd36aca81&chksm=cff4c49052d551515d73bc49a2bc9064d486f0e9958e7a82d77ce0f8873a0223b93160f8b2a5#rd)

一点说明  

  

经过一段高速的发展期后，QuantML社区目前进入了稳（ping）定（jing）阶段。量化投资上属于一个相对小众的领域，而QuantML所从事的研究更是小众中的细分赛道，这个赛道的天花板肉眼可见。不过，我们一直在积极思考如何扩大社区的规模，包括之前发布的招聘信息，吸引了众多朋友的关注和兴趣，期待未来团队能够逐步壮大。

同时，我们也经常收到社区成员的咨询，尤其是对量化投资感兴趣的新手们，他们最常问的问题是如何开始学习量化投资。为了更好地帮助这些新手入门，我们决定从本周起在公众号上开设一个面向初学者的专栏。这个专栏将提供一系列资料和文档，帮助新手们了解和学习量化投资的基础知识。

值得一提的是，这个专栏的所有服务都将是完全免费的。目前，我们的付费项目仅限于QuantML的星球社区，主要面向那些已经具备一定量化基础的从业人员。我们希望通过这样的方式，既能够满足不同层次用户的需求，也能够持续推动量化投资知识的普及和传播。
...
本期主要分享BOA的报告Everything you wanted to know about quant。  
...
这篇报告是关于量化策略和投资理念的深入分析。报告涵盖了多个方面，包括市场表现的驱动因素、量化投资策略、风险评估、以及特定行业的股票策略：

1.  市场表现驱动因素：报告探讨了影响市场表现的多个因素，包括估值、情绪、定位和公司利润。特别强调了估值在长期市场回报中的重要性，并提出了一个调整单周期偏见的估值方法。
    
2.  量化投资策略：报告详细介绍了70多个因子在过去约40年的表现，特别指出基于现金流的估值因子表现最佳。同时，报告还讨论了动量因子和技术分析因子在市场表现中的作用。
    
3.  风险评估：报告提供了对不同投资策略的风险/回报特征的分析，包括波动性、损失概率和风险调整后的因子回报。
    
4.  行业特定的股票策略：报告分析了不同行业（如通信服务、消费品、能源、金融、医疗保健、工业、信息技术、材料、房地产和公用事业）的特定股票策略，并提供了行业内长期和短期表现最佳的策略。
    
5.  ESG投资：报告探讨了环境、社会和治理（ESG）因素如何成为投资决策的一部分，并提供了关于ESG投资的量化分析。
    
6.  市场时机和宏观因素：报告包含了市场时机指标和因子表现与宏观环境的关系分析。
    
7.  量化模型和工具：报告介绍了BofA Securities使用的专有量化模型和工具，以及如何利用这些工具来识别投资机会。
    
8.  投资者情绪和市场趋势：报告通过分析投资者情绪、市场趋势和流动性风险，提供了对市场动态的见解。
    
9.  数据驱动研究：BofA Global Research使用了一系列数据驱动产品，包括客户流量、信用卡支出数据、地理位置数据、网络抓取和调查等，以提供对市场和行业的深入分析。
    
10.  风险管理：报告讨论了如何通过理解风险和使用适当的策略来管理投资组合风险。
