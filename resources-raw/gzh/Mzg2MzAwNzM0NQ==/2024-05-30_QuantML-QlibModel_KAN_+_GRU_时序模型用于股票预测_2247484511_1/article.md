...
QuantML QuantML 2024-05-30 22:07 上海

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=Mzg2MzAwNzM0NQ==&mid=2247484511&idx=1&sn=bb9168cb75b1b31fea0b8a5c3ce61d84&chksm=cfdae4afc7dc86f0217867fae88579fa06956af962d627aa328706efa230e39b9b2447931470#rd](https://mp.weixin.qq.com/s?__biz=Mzg2MzAwNzM0NQ==&mid=2247484511&idx=1&sn=bb9168cb75b1b31fea0b8a5c3ce61d84&chksm=cfdae4afc7dc86f0217867fae88579fa06956af962d627aa328706efa230e39b9b2447931470#rd)
...
在之前的文章中，我们将KAN结构单独用于因子的构建，但是股票预测需要历史信息，本文我们将KAN与金融时序中表现较好的GRU模型相结合，构建出KANGRU结构，相比于GRU结构，效果有所提升。  

模型采用GRU+KAN的结构，通过GRU提取时序特征，然后再利用KAN的特点将时序特征合成最终预测结果。
...
我们在中QuantML-Qlib实现KANGRU模型。由于有部分c代码，需要编译后再使用，在QuantML-Qlib根目录下运行以下命令进行编译
...
examples/benchmarks/KANGRU/workflow\_config\_kangru\_Alpha360.yaml文件中设置好数据路径，超参数后，运行run.py即可。

在中证500内测试，样本外周频IC为0.0657， IR为3.525，相比于GRU结构，均有所提升。

从回测结果来看，22-23年，相较于中证500年化alpha可达到13.62%左右，alpha最大回撤5%，alpha信息比1.51，表现相当不错。
