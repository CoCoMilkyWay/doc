# 利用预训练模型TimesFM进行股价预测

QuantML QuantML 2024-05-29 20:09 上海

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=Mzg2MzAwNzM0NQ==&mid=2247484500&idx=1&sn=b2aa3361888bebb6646ac1562afc5f1a&chksm=cfd141cc40a23ed3d3e61bf42d517b54dd1e9885df5829bb4d9945c3bf44ab11820cb2f70192#rd](https://mp.weixin.qq.com/s?__biz=Mzg2MzAwNzM0NQ==&mid=2247484500&idx=1&sn=b2aa3361888bebb6646ac1562afc5f1a&chksm=cfd141cc40a23ed3d3e61bf42d517b54dd1e9885df5829bb4d9945c3bf44ab11820cb2f70192#rd)
...
之前公众号介绍了google的新型时间序列预测基础模型TimesFM：[A decoder-only foundation model for time-series forecasting](http://mp.weixin.qq.com/s?__biz=Mzg2MzAwNzM0NQ==&mid=2247484484&idx=1&sn=1e37fee2b742fddfd011327dc7bcfcb4&chksm=ce7e635af909ea4c41b8c6c5a8e5090e8c999a7d18957746768ad95ee1578c513acc60f35235&scene=21#wechat_redirect)
...
参数量200M，CPU即可运行。google大约使用了1000亿时间点数据进行模型训练，主要包括google trend, wiki pageviews以及合成数据等。在各类时序问题上均取得了不错的效果。  

本文主要介绍如何使用TimesFM进行股价预测。
...
秉承了google的一贯传统，安装非常困难。windows下会有各种模型错误，花费了一天时间也没有搞定， 因此建议linux或者windows wsl下进行安装。  
...
进行安装，至此TimesFM已经安装成功。

  

模型的权重文件存储在huggingface：https://huggingface.co/google/timesfm-1.0-200m

  

可以使用git lfs下载或者在代码中下载。

  

接下来准备股票数据，从quantml-qlib中可以轻易调取股票数据，参见examples/tutorial/detailed\_workflow.ipynb
