# QuantML-Qlib | DEV版本发布

QuantML QuantML 2025-04-23 19:11 上海

> 原文地址: [https://mp.weixin.qq.com/s?\_\_biz=Mzg2MzAwNzM0NQ==&mid=2247490154&idx=1&sn=7dc2afbb89f5f553fed952bc16a72f23&chksm=cf68bad1be4a0c21eff919a80dbd474861bad2add9ac8231de7d0e55982e4bcdef4a7797f25a#rd](https://mp.weixin.qq.com/s?__biz=Mzg2MzAwNzM0NQ==&mid=2247490154&idx=1&sn=7dc2afbb89f5f553fed952bc16a72f23&chksm=cf68bad1be4a0c21eff919a80dbd474861bad2add9ac8231de7d0e55982e4bcdef4a7797f25a#rd)

QuantML-Qlib稳定版本基于qlib 0.9.3.99版本构建，但是随着python以及各类关键包（pandas,numpy）的不断升级，升级之后会带来一些小问题，虽然我们在教程中都提供了解决方法。

为了从根本上解决新旧版本冲突的问题，我们发布新的dev版quantml-qlib, 底层的qlib从0.9.3.99升级为最新的0.9.6.99版本（感谢qlib团队），新版本修复了一系列Bug的同时也带了一些新的特性。

主要更新：

-   修复数据列名错误
    
-   修复StaticDataLoader加载pkl文件bug
    
-   修复 CSI300 成分股数据源链接
    
-   修复强化学习（RL）相关文档中的链接
    
-   修复index\_data.py的datatype
    
-   增加新的数据下载源： 更新 chenditc/investment\_data 的链接以指向最新版本
    
-   引入data health checker: 检查数据安全
...
经过一段时间测试之后dev版本会正式merge到当前的stable版本。欢迎大家近期测试，提交bug。
